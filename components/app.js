class App {
  ...
  getFlightInfo() {
    ...
    this.flightURL = `https://skyscanner-skyscanner-flight-search-v1.p.rapidapi.com/apiservices/browseroutes/v1.0/US/USD/en-US/${this.originAirport}-sky/${this.randomAirport}-sky/${this.outboundDate}?inboundpartialdate=2020-12-01`
